...
class Produtos {
  Produtos(this.name, this.preco, this.url, this.url2, this.isFavorite);
  String name;
  String url;
  String url2;
  bool isFavorite;
...
class _ProductGridView extends State<ProductGridView> {
  void toggleFavorite(int index) {
    setState(() {
      produtos[index].isFavorite = !produtos[index].isFavorite;
    });
  }
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                toggleFavorite(index); // Passe o índice atual
                              },
                            ),
                          )
                        ],
